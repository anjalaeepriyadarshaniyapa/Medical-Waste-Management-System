 ...
 * Non Infectious Waste Model
 */
public class Non_Infectious_Waste {
    private String type_of_waste;
    private String object;
    private String type_of_container;
    private float wasteperday;

    public Non_Infectious_Waste() {
    }

    public Non_Infectious_Waste(String type_of_waste, String object, String type_of_container, float wasteperday) {
